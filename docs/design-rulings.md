...
## Appendix 44 — Transferring control: one window for the flying and the watching
...
So there is **one duration, covering both halves**. Press to launch and fly; press again
...
because the bar reads `Drone[17]` whether you are at the controls or standing three
