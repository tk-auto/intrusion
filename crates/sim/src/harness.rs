...
mod tests {
    ...
    fn the_default_config_reproduces_the_hardcoded_preset_byte_for_byte() {
        const PINNED: &str = "{\"seed\":42,\"profile\":\"balanced\",\"outcome\":\"capture\",\"turns\":116,\"detections\":3,\"takedowns\":0,\"bodies_found\":0,\"usage\":{\"wait\":12,\"run\":1,\"camouflage\":0,\"decoy\":0,\"dephase\":0,\"autodoors\":0,\"confusion\":0,\"takedown\":0,\"drag\":0,\"pierce_wall\":0,\"lockdown\":0,\"crouch\":0,\"stow\":0,\"silence_radio\":0,\"drone\":0,\"false_call\":0,\"dart\":0,\"repel\":0},\"alert_peak\":1,\"alert_escalations\":[{\"turn\":116,\"rung\":1,\"trigger\":\"sighting\"}],\"reinforcements\":0,\"par\":430,\"stars\":null,\"score\":null}";
