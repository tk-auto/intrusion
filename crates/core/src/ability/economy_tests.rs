...
fn the_catalog_matches_the_design_activated() {
    for (id, cost, targeting, duration, cooldown, effect) in [
        ...
        (
            ...
            // ground, and two abilities that buy a detour should be told apart by where
            // they work rather than by a clock. If they play as one press, the row to move
            // is `REPEL_RADIUS` — not this pair.
            AbilityId::Repel,
            1,
            TargetingMode::Itself,
            8,
