...
mod tests {
    ...
    /// for False Call and the Guide (#504/#505) and again for the Dart (#239): a shuffle
    /// over thirteen entries deals this seed a different three than a shuffle over twelve
    /// did. Every tech ever added moves this, and that is the point of pinning it —
    ...
    const GOLDEN_STOCK: [AbilityId; 3] =
        [AbilityId::Camouflage, AbilityId::Saver, AbilityId::Drone];
